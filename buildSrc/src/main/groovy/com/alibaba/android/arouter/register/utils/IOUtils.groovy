...
final class IOUtils {
    ...
    /**
     * Empty array of of type {@link java.nio.file.LinkOption}.
     *
     * @since 1.21
     */
     ...
     */
    static int readFully(final InputStream input, final byte[] array, final int offset, final int len)
            throws IOException {
     ...
     */
    static void readFully(final ReadableByteChannel channel, final ByteBuffer b) throws IOException {
     ...
     * @since 1.7
     */
    static void closeQuietly(final Closeable c) {
        if (c != null) {
            try {
                c.close();
     ...
     * @since 1.21
     */
    static void copy(final File sourceFile, final OutputStream outputStream) throws IOException {
     ...
     * @since 1.21
     */
    static long copyRange(final InputStream input, final long len, final OutputStream output,
     ...
     * @since 1.21
     */
    static byte[] readRange(final InputStream input, final int len) throws IOException {
        final ByteArrayOutputStream output = new ByteArrayOutputStream();
     ...
     * @since 1.21
     */
    static byte[] readRange(final ReadableByteChannel input, final int len) throws IOException {
        final ByteArrayOutputStream output = new ByteArrayOutputStream();
